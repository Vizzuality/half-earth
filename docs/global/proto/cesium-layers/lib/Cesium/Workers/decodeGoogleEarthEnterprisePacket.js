        ...
        function n(e, t) {
          ...
          if (l < d)
            for (u >= w && ((b = (b + 8) % 24), (u = b)); l < d; )
              s.setUint8(l, s.getUint8(l) ^ c.getUint8(u)), l++, u++;
        }
        var i = 1953029805,
          a = 2917034100;
          ...
          8: [
            function(e, t, r) {
              ...
              function w(e, t) {
                ...
                return e && e.state
                  ? ((r = e.state),
                    0 === (2 & r.wrap) ? U : ((r.head = t), (t.done = !1), A))
                  : U;
              }
              function b(e, t) {
                var r,
          ...
          9: [
            function(e, t, r) {
              ...
              t.exports = function(e, t, r, w, b, m, g, v) {
                ...
                for (I = B, U = i; U >= 1 && 0 === M[U]; U--);
                if ((I > U && (I = U), 0 === U))
                  return (
                    (b[m++] = 20971520), (b[m++] = 20971520), (v.bits = 1), 0
                  );
                for (R = 1; R < U && 0 === M[R]; R++);
                for (I < R && (I = R), N = 1, A = 1; A <= i; A++)
                  if (((N <<= 1), (N -= M[A]), N < 0)) return -1;
                if (N > 0 && (e === s || 1 !== U)) return -1;
    ...
    define(
      ...
      function(e, t, r, n, i) {
        ...
        function o(e, n, i) {
          ...
          if (((s += l), 1 !== d))
            throw new r("Invalid data type. Must be 1 for QuadTreePacket");
          ...
          if (((s += c), 32 !== m)) throw new r("Invalid instance size.");
        ...
        d.fromString = function(e) {
          return "Metadata" === e
            ? d.METADATA
            : "Terrain" === e ? d.TERRAIN : "DbRoot" === e ? d.DBROOT : void 0;
        };
        var h = 32301,
          w = 1953029805,
          b = 2917034100;
