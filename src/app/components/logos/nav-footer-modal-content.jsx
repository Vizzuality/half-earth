...
const partners = [
  { href: 'https://mol.org/', image: { src: '/img/partners/mol_logo.png', alt: 'Map of Life' } },
  {
    ...
    image: { src: '/img/partners/wilson.png', alt: 'Wilson Biodiversity Foundation', className: styles.eoImageModal }
  },
  {
...
const dataPartners = [
  { href: 'http://www.amphibians.org/', image: { src: '/img/partners/partner_image/1.png', alt: 'amphibians' } },
  {
    href: 'http://www.birdlife.org/',
    image: { src: '/img/partners/partner_image/2.png', alt: 'BirdLife International' }
  },
  { href: 'https://www.rspb.org.uk/', image: { src: '/img/partners/partner_image/3.png', alt: 'rspb' } },
  {
  ...
  { href: 'https://www.gbif.org/', image: { src: '/img/partners/partner_image/7.png', alt: 'gbif' } },
  { href: 'https://www.thegef.org/', image: { src: '/img/partners/partner_image/8.png', alt: 'gef' } },
  {
  ...
  { href: 'https://www.iucn.org/', image: { src: '/img/partners/partner_image/11.png', alt: 'iucn' } },
  {
  ...
  { href: 'http://www.natureserve.org/', image: { src: '/img/partners/partner_image/16.png', alt: 'nature serve' } },
  {
    href: 'https://www.nature.org/',
    image: { src: '/img/partners/partner_image/17.png', alt: 'the nature conservancy' }
  },
  { href: 'https://www.unep-wcmc.org/', image: { src: '/img/partners/partner_image/19.png', alt: 'unep-wcmc' } },
  { href: 'https://www.wcs.org', image: { src: '/img/partners/partner_image/21.png', alt: 'wcs' } },
  { href: 'https://www.worldwildlife.org/', image: { src: '/img/partners/partner_image/22.png', alt: 'wwf' } }
];
...
const researchPartners = [
  ...
  { href: 'https://www.nybg.org', image: { src: '/img/partners/partner_image/28.png', alt: 'mncn' } },
  {
  ...
  { href: 'https://www.yale.edu/', image: { src: '/img/partners/partner_image/33.png', alt: 'Yale University' } },
  {
...
const engagementPartners = [
  { href: 'http://www.msichicago.org/', image: { src: '/img/partners/partner_image/31.png', alt: 'msic' } },
  { href: 'http://www.opsociety.org/', image: { src: '/img/partners/partner_image/32.png', alt: 'OPS' } }
];

const modelConservationEffortsPartners = [
  { href: 'http://tesf.org/', image: { src: '/img/partners/partner_image/14.png', alt: 'tesf' } },
  { href: 'http://www.gorongosa.org/', image: { src: '/img/partners/partner_image/13.png', alt: 'gorongosa' } },
  {
...
const sections = [
  { title: 'Half-earth mapping core', content: partners },
