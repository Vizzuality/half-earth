...
const Expand = ({ expand, isOpen, info, children, openPopup, label, ...props }) => {
    ...
    (
      <div key="expand-btn" className={styles.expand}>
        ...
        <span className={styles.label}>
          ...
          {info && <Info className={styles.paneInfo} onClick={() => openPopup(info)} />}
        </span>
      </div>
    ),
    (
      <div key="expand-pane" className={cx(styles.collapse, { [styles.collapseClosed]: !isOpen })}>
