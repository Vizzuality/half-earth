...
class Scroller extends PureComponent {
  ...
  componentDidMount() {
    ...
    this.subscription = this.source.subscribe(this.onTick, this.onError, this.onComplete);
  }
    ...
    return [
      (
        <div
          key="playhead"
          id="playhead"
          className={cx(styles.playHead, { [className]: className, [styles.playHeadVisible]: playhead })}
        />
      ),
