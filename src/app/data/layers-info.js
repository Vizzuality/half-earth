...
export const layersInfo = [
  {
    ...
    subtitle: 'Birds, Mammals, Amphibians, Conifers, Cacti, Turtles and All Taxa',
    description: 'Maps show patterns for grid cells of 110 x 110 km size. The cell size reflects the resolution at which currently available data, without further models, allow an accurate characterization, globally. “Richness” shows the count of species in a cell. The ‘All Groups’ layer provide a sum (species richness) of currently shown groups.',
    source: () => (
      <span>
  ...
  },
  {
    ...
    key: 'protected-areas',
    subtitle: '',
    description: 'The most comprehensive dataset of protected areas globally that is used to measure the amount of the globe within protected areas. Protected areas in this dataset include national parks, state parks, nature reserves, wilderness areas, and national forest.',
    source: () => (
      <span>
  ...
  },
  {
    ...
    source: () => (
      <span>
        {' '}
        'We used the standardized ESA Global Land Cover product (
        <a target="_blank" href="https://www.esa-landcover-cci.org/">
          ESA Climate Change Initiative Land Cover
        </a>
        , accessed Nov 2017) to characterize areas in 2015 that encumbered
  ...
  },
  {
    ...
    subtitle: '',
    description: 'The World Database on Protected Areas includes most of the global area under formal protection. However, there are many conservation initiatives that are protecting biodiversity outside of these official reserves. For example, there are community-based conservation approaches that involve collaborations between private landowners and government bodies.',
    source: () => (
      <span>
        {}
        Map of Life and supporting datasets
...
export default { global: layersInfo, regional: layersInfo };
