      ...
      <div className={className}>
        <Scroller>
          ...
          <P
            ...
            onScrollFocus={() => setSection('global:1')}
          >
          ...
          <P
            className={uiStyles.slides}
            onScrollFocus={() => setSection('global:2')}
          >
            ...
            and {t('cacti')}
            species. There are countless more species that haven’t been
            ...
            <SpiderChart data={graph.graphs} />
          </P>
          <P
            className={cx(uiStyles.slides, uiStyles.paragraphAfterChart)}
            onScrollFocus={() => setSection('global:3')}
          >
          ...
          <P
            className={uiStyles.slides}
            onScrollFocus={() => setSection('global:4')}
          >
          ...
          <P
            className={uiStyles.slides}
            onScrollFocus={() => setSection('global:5')}
          >
