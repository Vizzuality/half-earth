...
const mergedActions = { ...actions, ...mapActions, ...analyticsActions, ...sectionActions };
...
class HomeContainer extends Component {
  ...
  render() {
    return createElement(HomeComponent, { ...this.props, onClick: this.onClick });
  }
}

export default connect(null, mergedActions)(HomeContainer);
