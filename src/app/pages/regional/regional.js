...
class RegionalConTainer extends Component {
  constructor(props) {
    super(props);
    const { getCartoTiles, setRegionalSectionThunk, setSection, getBillboards } = props;
...
export const reduxConfig = { reducers, initialState, actions };
export default connect(mapStateToProps, { ...cartoActions, ...actions, ...sectionActions })(RegionalConTainer);
